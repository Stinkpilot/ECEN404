...
//
//------------------------------------------------------------------------------------------------------------
#define PORT_HUMIDITY_SENSOR   7   // Humidity sensor connected at 
...
//
//------------------------------------------------------------------------------------------------------------
void read_data(double *temp, double *humid, int *valid_data)
{
    int i ; 
    int data_bit ; 
    ...
    printf("\n data : %d %d %d %d %d", hex[0], hex[1], hex[2], hex[3], hex[4]) ;
...
{ 
    ...
    ////////////////////////////////////////////////////////////////////////////////
	printf("Keep pinging the sensor every 5 sec\n");
    ...
    for(i=0;i<1;)    {
        ...
        printf("Starting the handshake\n"); 
	//printf("data read = %d", read_sensor(0)) ; 
        request_data();  // performs the initial handshake required to request data 
                         // from the sensor 
			 //
	

        read_data(temperature, humidity, valid_data);     // performs the serial read and outputs the temp, humid and 
                                                          // valid data 
    

        //printf("Read the data from the sensor\n"); 
        //printf("Checksum matched : %d,  Temperature = %f, Humidity = %f", valid_data, temperature, humidity);  
	i = i+1; 
